module.exports = {
    sv: {
      ...
      benefitsFysiskFeatures: [
        'Styrka & Muskler: Bygger muskler och ökar styrka. Styrketräning gör dig starkare, vilket underlättar vardagliga aktiviteter som att lyfta matkassar, bära barn eller klättra i trappor. Ökad muskelmassa förbättrar kroppens utseende och hållning.',
        'Fettförbränning: Ökar fettförbränning och ämnesomsättning. Muskler förbränner mer kalorier i vila än fett, vilket höjer din vilometabolism. Styrketräning i kombination med kondition kan påskynda viktminskning och hjälpa till att bibehålla en hälsosam kroppsvikt.',
        'Benhälsa: Förbättrar benhälsa. Regelbunden styrketräning ökar bentätheten och minskar risken för benskörhet (osteoporos), särskilt viktigt när du blir äldre.',
        'Hjärt- & Kärlhälsa: Förbättrar hjärt- och kärlhälsa. Styrketräning kan sänka blodtrycket, förbättra kolesterolvärden och minska risken för hjärt-kärlsjukdomar, särskilt i kombination med konditionsträning.'
      ],
      ...
      // Packages Data
      packagesData: {
        summer: { title: 'Sommarkampanj', duration: '3 Månader', price: '1856 kr', subPrice: 'Halva priset!', badge: 'Sommar-deal', features: ['Personligt anpassat träningsprogram', 'Anpassat kostschema utifrån dina mål', 'Kontinuerlig uppföljning och coachning', 'Teknikanpassad träning för att undvika skador', 'Gäller t.o.m. 31/8 - Säljstart 1 maj', '14 dagars ångerrätt'] },
        'black-friday': { title: 'Black Friday Transformation', duration: '12 Veckor', price: '1919 kr', subPrice: 'Du sparar 65%', badge: 'Oslagbart pris', features: ['100% skräddarsytt träningsprogram', 'Skräddarsytt kostschema', 'Kontinuerlig uppföljning & coachning', 'Instruktionsvideor för övningar', 'Säljstart 20 november', 'Begränsat antal platser'] },
        christmas: { title: 'Julerbjudande', duration: '16 Veckor', price: '1999 kr', subPrice: 'Bästa julklappen till dig själv', badge: 'Jul-deal', features: ['Anpassat träningsprogram (gym eller hemma)', 'Skräddarsytt och flexibelt kostschema', 'Regelbundna check-ins med coach', 'Videoguide för säker teknik', 'Säljstart 1 december', 'Gåva som varar långt efter jul'] },
        'pt-online-26': { title: 'Komplett PT-paket', duration: '26 Veckor', price: '4699 kr', subPrice: 'Student/Ungdom/Pensionär: 4250 kr', badge: 'Mest prisvärt', features: ['Skräddarsydd träning & kost efter dina mål', 'Progressiv belastningsjustering varje månad', 'Detaljerade övningar med videoklipp', 'Regelbundna check-ins (vecko/månadsvis)', 'Helhetsperspektiv (sömn, återhämtning, kondition)', 'Support via WhatsApp & e-post'] },
        'next-level-26': { title: 'Next Level 26', duration: '26 Veckor', price: '4105 kr', subPrice: 'Student/Ungdom/Pensionär: 3828 kr', badge: 'Flerspråkig', features: ['Skräddarsytt träningsprogram & kost', 'Flerspråkigt stöd (coaching på modersmål)', 'Stöd för Arabiska, Turkiska, Persiska, Tyska m.fl.', 'Obegränsad support via WhatsApp/e-post', 'Regelbundna uppdateringar och anpassningar', '100% trygghet och tydligare kommunikation'] },
        'body-reboot-26': { title: 'Body Reboot 26', duration: '26 Veckor', price: '3850 kr', subPrice: 'Student/Ungdom/Pensionär: 3250 kr', badge: 'För erfarna', features: ['För medel eller avancerade motionärer', 'Kräver god grundläggande kunskap i teknik', 'Professionellt utformad progressionsplan', 'Löpande expertstöd för kost & träning', 'Hållbara vanor utan strikta dieter eller förbud', 'Regelbundna check-ins för optimala resultat'] },
        'lifestyle-16': { title: 'Livsstilsstarten', duration: '16 Veckor', price: '3105 kr', subPrice: 'Student/Ungdom/Pensionär: 2840 kr', badge: 'Populär', features: ['Skräddarsytt tränings- & kostprogram', 'Optimal näringsbalans (protein, fiber, vitaminer)', 'Enkla & varierade recept (anpassat för veggan/allergier)', 'Videoinstruktioner på alla styrkeövningar', 'Löpande feedback och justeringar', 'Sömn- och återhämtningsrådgivning'] },
        'glute-leg-16': { title: 'Glute & Leg Specialist', duration: '16 Veckor', price: '3000 kr', subPrice: 'Student/Ungdom/Pensionär: 2810 kr', badge: 'För tjejer', features: ['Endast för tjejer (alla nivåer)', 'Fokus på träning av rumpa och ben', 'Inkluderar även träning för resten av kroppen', 'Komplett kostschema med optimal näringsbalans', 'Obegränsad support via chatt', 'Regelbundna programuppdateringar'] },
        'fokus-12': { title: 'Fokus 12', duration: '12 Veckor', price: '2469 kr', subPrice: 'Student/Ungdom/Pensionär: 2215 kr', badge: 'Standard', features: ['Personligt anpassat träningsprogram', 'Hållbart kostschema (utan krångliga dieter)', 'Kontinuerlig uppföljning och coachning', 'Instruktionsvideor för alla styrkeövningar', 'Expertråd om vitaminer och kosttillskott', 'Löpande feedback och schemajusteringar'] },
        'health-8': { title: 'Styrka & Hälsa', duration: '8 Veckor', price: '1829 kr', subPrice: 'Student/Ungdom/Pensionär: 1499 kr', badge: 'Intensiv', features: ['Snabb 8-veckors transformation', 'Skräddarsytt träningsprogram (gym eller hemma)', 'Anpassat kostschema baserat på mat du gillar', 'Veckovisa check-ins för att hålla motivationen uppe', 'Instruktionsvideor för säker teknik', 'Komplett guide för att nå dina drömresultat'] },
        'kickstart-4': { title: 'Projekt 4 Veckor', duration: '4 Veckor', price: '1129 kr', subPrice: 'Student/Ungdom/Pensionär: 856 kr', badge: 'Kickstart', features: ['Kraftfull kickstart eller för att bryta en platå', 'Intensiv träningsplan anpassad för alla nivåer', 'Enkelt och hållbart kostschema', 'Tät kontakt med din coach', 'Instruktionsvideor för alla övningar', 'Snabb återkoppling på dina framsteg'] },
        nutrition: { title: 'Avancerat Kostschema', duration: 'Engångsköp', price: '2458 kr', subPrice: 'Komplett måltidsplan', badge: 'Bara kost', features: ['20 unika och funktionella måltidsrecept', 'Fördelat på 5 näringsrika måltider per dag', 'Anpassat efter din livsstil och dina matpreferenser', 'Optimal näringsbalans (protein, fiber, vitaminer)', 'Lättlagad mat som ger stabil blodsockernivå', 'Guide till att äta smartare och må bättre'] },
        'tech-60': { title: 'Teknikträning', duration: '60 Minuter', price: '499 kr', subPrice: 'Student/Ungdom/Pensionär: 340 kr', badge: 'Fysiskt pass', features: ['Fysisk session för korrekt teknik i övningar', 'Fokus på marklyft, knäböj och bänkpress', 'Möjlighet att välja specifika övningar själv', 'Session uppdelad i uppvärmning & teknikfokus', 'Tydliga instruktioner för att undvika skador', 'Nedvarvning och feedback ingår'] },
        'individual-pt': { title: 'Individuell PT-träning', duration: '60 Minuter / pass', price: '499 kr', subPrice: 'Boka 20 pass för 7850 kr (392 kr/pass)', badge: 'Fysisk PT', features: ['Fysiska träningspass anpassade efter dina mål', 'Inkluderar även personligt anpassat träningsprogram', 'Kopplat kostschema anpassat efter din vardag', 'Kontinuerlig uppföljning och coachning ingår', 'Teknikanpassad träning på gymmet', 'Flexibla träningstider'] }
      },
    ...
    en: {
      ...
      benefitsFysiskFeatures: [
        'Strength & Muscles: Builds muscle and increases strength. Strength training makes you stronger, facilitating daily activities such as lifting groceries, carrying children, or climbing stairs. Increased muscle mass improves body shape and posture.',
        'Fat loss: Increases fat loss and metabolism. Muscle burns more calories at rest than fat, raising your resting metabolic rate. Strength training combined with cardio can accelerate weight loss and help maintain a healthy body weight.',
        'Bone health: Improves bone health. Regular strength training increases bone density and reduces the risk of osteoporosis, which is particularly important as you age.',
        'Cardio health: Improves cardiovascular health. Strength training can lower blood pressure, improve cholesterol levels, and reduce the risk of heart disease, especially when combined with cardio training.'
      ],
      benefitsMentalTitle: 'Mental benefits',
      benefitsMentalFeatures: [
        'Boosts self-confidence: Seeing physical progress, like increased strength or a more toned body, boosts self-esteem.',
        "Reduces stress and improves mood: Strength training releases endorphins, the body's \"feel-good hormones\", which can relieve stress, anxiety, and depression. Regular exercise can also improve sleep quality.",
      ...
      // Packages Data
      packagesData: {
        summer: { title: 'Summer Campaign', duration: '3 Months', price: '1856 SEK', subPrice: 'Half price!', badge: 'Summer Deal', features: ['Personalized training program', 'Tailored diet plan based on your goals', 'Continuous follow-up and coaching', 'Technique adjustment to avoid injury', 'Valid until 31/8 - Sales start May 1', '14-day cancellation policy'] },
        'black-friday': { title: 'Black Friday Transformation', duration: '12 Weeks', price: '1919 SEK', subPrice: 'You save 65%', badge: 'Unbeatable Price', features: ['100% customized training program', 'Customized nutrition plan', 'Continuous follow-up & coaching', 'Instructional exercise videos', 'Sales start November 20', 'Limited availability'] },
        christmas: { title: 'Christmas Offer', duration: '16 Weeks', price: '1999 SEK', subPrice: 'The best gift to yourself', badge: 'Christmas Deal', features: ['Tailored training program (gym or home)', 'Tailored and flexible diet plan', 'Regular check-ins with coach', 'Video guide for safe technique', 'Sales start December 1', 'A gift that lasts long after Christmas'] },
        'pt-online-26': { title: 'Complete PT Package', duration: '26 Weeks', price: '4699 SEK', subPrice: 'Student/Youth/Senior: 4250 SEK', badge: 'Best Value', features: ['Tailored training & diet according to goals', 'Progressive loading adjustment every month', 'Detailed exercises with videos', 'Regular check-ins (weekly/monthly)', 'Holistic view (sleep, recovery, cardio)', 'Support via WhatsApp & email'] },
        'next-level-26': { title: 'Next Level 26', duration: '26 Weeks', price: '4105 SEK', subPrice: 'Student/Youth/Senior: 3828 SEK', badge: 'Multilingual', features: ['Tailored training program & diet', 'Multilingual support (coaching in mother tongue)', 'Support for Arabic, Turkish, Persian, German, etc.', 'Unlimited support via WhatsApp/email', 'Regular updates and adjustments', '100% security and clearer communication'] },
        'body-reboot-26': { title: 'Body Reboot 26', duration: '26 Weeks', price: '3850 SEK', subPrice: 'Student/Youth/Senior: 3250 SEK', badge: 'For Experienced', features: ['For intermediate or advanced exercisers', 'Requires good basic technique knowledge', 'Professionally designed progression plan', 'Ongoing expert diet & training support', 'Sustainable habits without strict diets', 'Regular check-ins for optimal results'] },
        'lifestyle-16': { title: 'Lifestyle Start', duration: '16 Weeks', price: '3105 SEK', subPrice: 'Student/Youth/Senior: 2840 SEK', badge: 'Popular', features: ['Tailored training & nutrition program', 'Optimal nutritional balance (protein, fiber, vitamins)', 'Simple & varied recipes (adapted for vegans/allergies)', 'Video instructions for all strength exercises', 'Ongoing feedback and adjustments', 'Sleep and recovery advice'] },
        'glute-leg-16': { title: 'Glute & Leg Specialist', duration: '16 Weeks', price: '3000 SEK', subPrice: 'Student/Youth/Senior: 2810 SEK', badge: 'For Girls', features: ['Only for girls (all levels)', 'Focus on glutes and legs', 'Includes training for the rest of the body', 'Complete diet plan with optimal nutrition', 'Unlimited support via chat', 'Regular program updates'] },
        'fokus-12': { title: 'Focus 12', duration: '12 Weeks', price: '2469 SEK', subPrice: 'Student/Youth/Senior: 2215 SEK', badge: 'Standard', features: ['Personalized training program', 'Sustainable diet plan (no complicated diets)', 'Continuous follow-up and coaching', 'Instructional videos for all strength exercises', 'Expert advice on vitamins & supplements', 'Ongoing feedback and schedule adjustments'] },
        'health-8': { title: 'Strength & Health', duration: '8 Weeks', price: '1829 SEK', subPrice: 'Student/Youth/Senior: 1499 SEK', badge: 'Intensive', features: ['Fast 8-week transformation', 'Customized training program (gym or home)', 'Tailored diet plan based on food you like', 'Weekly check-ins to maintain motivation', 'Instructional videos for safe technique', 'Complete guide to reach your dream results'] },
        'kickstart-4': { title: 'Project 4 Weeks', duration: '4 Weeks', price: '1129 SEK', subPrice: 'Student/Youth/Senior: 856 SEK', badge: 'Kickstart', features: ['Powerful kickstart or to break a plateau', 'Intense training plan adapted for all levels', 'Simple and sustainable diet plan', 'Close contact with your coach', 'Instructional videos for all exercises', 'Fast feedback on your progress'] },
        nutrition: { title: 'Advanced Diet Plan', duration: 'One-time purchase', price: '2458 SEK', subPrice: 'Complete meal plan', badge: 'Diet only', features: ['20 unique and functional meal recipes', 'Distributed over 5 nutrient-rich meals per day', 'Adapted to your lifestyle and food preferences', 'Optimal nutritional balance (protein, fiber, vitamins)', 'Easy-to-cook food providing stable blood sugar', 'Guide to eating smarter and feeling better'] },
        'tech-60': { title: 'Technique Training', duration: '60 Minutes', price: '499 SEK', subPrice: 'Student/Youth/Senior: 340 SEK', badge: 'Physical pass', features: ['Physical session for correct exercise technique', 'Focus on deadlift, squat, and bench press', 'Option to select specific exercises yourself', 'Session split into warm-up & technique focus', 'Clear instructions to avoid injuries', 'Cool-down and feedback included'] },
        'individual-pt': { title: 'Individual PT Training', duration: '60 Minutes / session', price: '499 SEK', subPrice: 'Book 20 sessions for 7850 SEK (392 SEK/session)', badge: 'Physical PT', features: ['Physical sessions customized to your goals', 'Includes personalized training program', 'Connected diet plan adapted to your daily life', 'Continuous follow-up and coaching included', 'Technique adjustment at the gym', 'Flexible training times'] }
      },
    ...
    fa: {
      ...
      benefitsFysiskFeatures: [
        'قدرت و عضلات: ساخت عضلات قوی و آسان‌تر کردن کارهای روزمره. تمرینات قدرتی شما را قوی‌تر می‌کند و کارهای روزانه مانند حمل خریدهای خانه، بغل کردن کودکان یا بالا رفتن از پله‌ها را تسهیل می‌کند. افزایش حجم عضلانی فرم و ایستادگی بدن را بهبود می‌بخشد.',
        'چربی‌سوزی بالا: متابولیسم شما را حتی در زمان استراحت افزایش می‌دهد. عضلات در زمان استراحت کالری بیشتری نسبت به چربی می‌سوزانند که باعث افزایش متابولیسم پایه شما می‌شود. تمرینات قدرتی همراه با هوازی می‌تواند کاهش وزن را سرعت بخشیده و به حفظ وزن سالم کمک کند.',
        'سلامت استخوان‌ها: افزایش تراکم استخوانی و پیشگیری از پوکی استخوان، به ویژه با افزایش سن.',
        'سلامت قلب و عروق: کاهش فشار خون، بهبود سطح کلسترول خون و کاهش خطر بیماری‌های قلبی، به ویژه در ترکیب با تمرینات هوازی.'
      ],
    ...
    en: {
      ...
      benefitsMentalTitle: 'Mental benefits',
      benefitsMentalFeatures: [
        'Confidence: Physical progress and increased strength lift self-esteem.',
        'Less stress: Releases endorphins that relieve anxiety and stress.',
        'Better sleep: Regular training significantly improves sleep quality.',
        'Long-term health: Combats age-related muscle loss (sarcopenia).'
      ],
    ...
    fa: {
      ...
      benefitsMentalTitle: 'فواید ذهنی و روانی',
      benefitsMentalFeatures: [
        'اعتماد به نفس: پیشرفت فیزیکی و قوی‌تر شدن، عزت نفس را بالا می‌برد.',
        'کاهش استرس: ترشح اندورفین که به کاهش اضطراب و استرس شدید کمک می‌کند.',
        'خواب عمیق و باکیفیت: تمرینات منظم کیفیت خواب شما را به شدت بهبود می‌بخشد.',
        'سلامت طولانی‌مدت: پیشگیری از تحلیل رفتن عضلات بر اثر افزایش سن (سارکوپنی).'
      ],
      ...
      idealName: 'نام: سوفی',
      idealAge: 'سن: ۲۰ تا ۴۵ سال',
      idealJob: 'شغل: صاحب کسب‌وکار کوچک / کارآفرین',
      idealSituation: 'وضعیت زندگی: زندگی روزمره فعال اما پر از استرس همراه با خانواده و مدیریت کسب‌وکار. ایجاد تعادل بین کار و سلامتی برای او یک چالش بزرگ است.',
      idealGoalsTitle: 'اهداف',
      idealGoals: [
        'کاهش وزن، افزایش انرژی و کاهش استرس روزانه.',
        'بهبود سلامت قلب و عروق و قدرت عمومی بدن.',
        'یافتن یک سبک زندگی سالم‌تر و پایدار که در طولانی‌مدت کارساز باشد.'
      ],
      idealChallengesTitle: 'چالش‌ها',
      idealChallenges: [
        'کمبود زمان به دلیل مشغله‌های زیاد کاری و خانوادگی.',
        'کمبود انگیزه و دشواری در حفظ و اجرای منظم روال‌ها به تنهایی.',
        'سردرگمی در مورد نحوه صحیح تمرین و تغذیه.',
        'سابقه امتحان کردن رژیم‌ها و برنامه‌های مختلف در گذشته بدون نتایج ماندگار.'
      ],
      idealPainTitle: 'دغدغه‌ها و نقاط ضعف',
      idealPain: [
        'احساس خستگی مداوم، بی‌حالی و کمبود انرژی در طول روز.',
        'نارضایتی از فرم بدنی و وضعیت ایستایی بدن.',
        'دشواری در اولویت‌بندی زمان برای خود و سلامتی شخصی.',
        'احساس سردرگمی در میان اطلاعات ضد و نقیض فراوان درباره تغذیه و ورزش.',
        'نیاز به کسی که او را راهنمایی کند، انگیزه دهد و او را متعهد نگه دارد.'
      ],
      idealSearchTitle: 'آنچه او در یک مربی جستجو می‌کند',
      idealSearch: [
        'یک مربی شخصی با دانش بالا و متعهد که چالش‌های زندگی او را درک کند.',
        'یک برنامه تمرینی کارآمد، جذاب و متناسب با جدول زمانی شلوغ او.',
        'توصیه‌های غذایی ساده، مغذی و قابل اجرا در زندگی روزمره.',
        'پشتیبانی، انگیزه و بازخوردهای مستمر برای ماندن در مسیر صحیح.'
      ],

      termsSubtitle: 'شرایط و اطلاعات خرید',
      termsTitle: 'شرایط و اطلاعات خرید برای پکیج‌های ترکیبی (هیبرید)',
      termsIntro: 'برنامه ترکیبی (هیبریدی) ما برای مربیگری شخصی انفرادی، جلسات حضوری PT را با جلسات دیجیتال و پشتیبانی مستمر از طریق یک پلتفرم آنلاین ترکیب می‌کند. این برنامه شامل برنامه ورزشی و تغذیه‌ای کاملاً اختصاصی متناسب با اهداف شماست – چه بخواهید به بدن خود شکل دهید، وزن کم کنید یا عضله‌سازی کنید. در ادامه شرایط و اطلاعات خرید دقیق برای تضمین تجربه‌ای مطمئن و منعطف آورده شده است.',
      termsSections: [
        {
          title: '۱. حق انصراف (۱۴ روزه)',
          content: 'طبق قانون قراردادهای از راه دور (2005:59)، شما حق دارید ظرف ۱۴ روز از زمان انعقاد قرارداد (مثلاً زمانی که اولین تاییدیه، برنامه تمرینی/غذایی یا دسترسی به پلتفرم آنلاین را دریافت می‌کنید) خرید خود را لغو کنید. این قانون شامل هر دو خدمات آنلاین و حضوری خریداری شده از راه دور (مانند وب‌سایت، ایمیل یا پیامک) می‌شود.'
        },
        {
          title: 'استثنائات برای خدمات شروع شده',
          content: 'اگر در طول دوره حق انصراف استفاده از خدمات را آغاز کرده باشید (مثلاً یک جلسه PT حضوری انجام داده باشید، به برنامه تمرینی دیجیتال دسترسی پیدا کرده باشید یا از برنامه غذایی استفاده کرده باشید)، ممکن است هزینه‌ای متناسب با بخش استفاده شده از شما دریافت شود. در صورتی که یک جلسه PT حضوری یا یک دوره آنلاین به طور کامل ارائه شده باشد، حق انصراف برای آن خدمت خاص از بین می‌رود.'
        },
        {
          title: 'نحوه اعلام انصراف',
          content: 'انصراف خود را به صورت کتبی از طریق ایمیل به آدرس info.musclefocus@gmail.com ظرف مدت ۱۴ روز پس از خرید اعلام کنید. نام، شماره سفارش و تمایل خود به استفاده از حق انصراف را ذکر کنید.'
        },
        {
          title: 'بازپرداخت وجه',
          content: 'در صورت انصراف، کل مبلغ (منهای هزینه‌های خدمات ارائه شده تا آن لحظه) ظرف مدت ۱۴ روز از زمان دریافت درخواست انصراف بازپرداخت خواهد شد. بازپرداخت از طریق همان روش پرداخت خرید (مانند کارت، Swish) و بدون هزینه اضافی انجام می‌شود.'
        },
        {
          title: '۲. بدون هزینه‌های مستمر و دوره‌های تعهد اجباری',
          content: 'پرداخت یک‌باره برای پکیج‌ها: پکیج‌های هیبریدی ما (مانند ۱۰، ۲۰ یا ۳۰ جلسه) خرید یک‌باره هستند و تمدید خودکار یا هزینه‌های پنهان ندارند. پس از اتمام جلسات، خدمات به طور خودکار پایان می‌یابند مگر اینکه مایل به خرید پکیج جدید باشید. بدون دوره‌های تعهد اجباری: هیچ‌یک از خدمات حضوری یا دیجیتال ما دوره تعهد اجباری ندارند که به شما انعطاف‌پذیری کامل می‌دهد.'
        },
        {
          title: '۳. متوقف کردن موقت خدمات در صورت نیاز',
          content: 'جلسات حضوری: جلسات استفاده نشده PT متوقف شده و می‌توانند تا ۱۲ ماه پس از تاریخ خرید استفاده شوند، به شرطی که قبل از اتمام مهلت به ما اطلاع دهید. خدمات آنلاین: دسترسی به برنامه‌های دیجیتال، برنامه‌های غذایی و کوچینگ مربی بدون هزینه اضافی متوقف شده و تا ۱۲ ماه پس از خرید معتبر است تا هر زمان که آماده بودید مجدداً فعال شود.'
        },
        {
          title: '۴. قیمت‌ها و نحوه پرداخت',
          content: 'ساختار قیمت‌ها: تمامی قیمت‌ها جهت شفافیت بدون احتساب مالیات بر ارزش افزوده (moms) اعلام می‌شوند. مالیات بر ارزش افزوده مربوطه (مانند ۶٪ برای خدمات ورزشی/PT و ۲۵٪ برای برخی خدمات دیجیتال) در زمان خرید اضافه شده و در رسید یا تاییدیه سفارش نشان داده می‌شود. گزینه‌های پرداخت: پرداخت از طریق کارت، Swish، فاکتور یا اقساطی (مانند Klarna) امکان‌پذیر است.'
        },
        {
          title: '۵. پشتیبانی و زمان پاسخگویی',
          content: 'پشتیبانی حضوری: مربی شما در طول جلسات رزرو شده و همچنین از طریق ایمیل/تلفن جهت پیگیری وضعیت در دسترس است. پشتیبانی آنلاین: از طریق اپلیکیشن، ایمیل یا تماس تصویری در دسترس است و پاسخگویی ظرف ۲۴ تا ۴۸ ساعت در روزهای کاری انجام می‌شود. در روزهای تعطیل زمان پاسخگویی ممکن است تا ۷۲ ساعت افزایش یابد.'
        },
        {
          title: '۶. اطلاعات شخصی و امنیت داده‌ها (GDPR)',
          content: 'جمع‌آوری اطلاعات شخصی: ما اطلاعات شخصی شما (مانند نام، ایمیل، شماره تلفن، جزئیات پرداخت، اهداف تمرینی، داده‌های سلامتی و اندازه‌گیری‌های بدنی) را جهت ارائه و شخصی‌سازی برنامه‌ها جمع‌آوری و پردازش می‌کنیم. این کار کاملاً مطابق با قوانین GDPR اتحادیه اروپا انجام می‌شود. ما هرگز اطلاعات یا داده‌های شخصی شما را در اختیار اشخاص غیرمجاز قرار نمی‌دهیم.'
        }
      ],
      
      partnersTitle: 'همکاران ما',
      partnersSubtitle: 'شبکه ارتباطی ما',

      // Packages Page
      packagesSubtitle: 'خدمات ما',
      packagesTitle: 'پکیج‌های تمرینی و برنامه‌های غذایی',
      packagesIntro: 'پکیجی را که با سبک زندگی و اهداف شما همخوانی دارد انتخاب کنید. تمام پکیج‌های آنلاین شامل برنامه غذایی اختصاصی و برنامه تمرینی همراه با پشتیبانی مربی است.',
      packagesBtnBook: 'ثبت نام و درخواست',
      packagesCategories: {
        all: 'همه پکیج‌ها',
        campaign: 'جشنواره‌ها و کمپین‌ها',
        'online-long': 'مربی آنلاین (طولانی مدت)',
        'online-short': 'مربی آنلاین (کوتاه مدت)',
        'physical-nutrition': 'برنامه غذایی و جلسات حضوری'
      },
      conditionsTitle: 'قوانین و اطلاعات خرید',
      conditionsItems: [
        { title: 'حق انصراف ۱۴ روزه', desc: 'شما تا ۱۴ روز پس از سفارش حق انصراف از خرید را دارید. در صورت شروع خدمات، هزینه روزهای ارائه شده محاسبه می‌شود.' },
        { title: 'بدون تعهدات طولانی مدت اجباری', desc: 'تمامی قیمت‌ها به صورت پرداخت یک‌باره هستند. هیچ هزینه پنهان یا پرداخت‌های ماهانه مداومی پس از پایان پکیج وجود ندارد.' },
        { title: 'امکان متوقف کردن موقت', desc: 'جلسات حضوری مربیگری و خدمات آنلاین را می‌توان بدون هزینه اضافی تا مدت ۱۲ ماه متوقف و ذخیره کرد.' }
      ],

      // Packages Data
      packagesData: {
        summer: { title: 'کمپین تابستانه', duration: '۳ ماهه', price: '۱۸۵۶ کرون', subPrice: 'نصف قیمت واقعی!', badge: 'ویژه تابستان', features: ['برنامه تمرینی کاملا شخصی‌سازی شده', 'برنامه غذایی متناسب with اهداف شما', 'پشتیبانی و کوچینگ مداوم در طول دوره', 'تنظیم تکنیک حرکت برای جلوگیری از آسیب', 'معتبر تا تاریخ ۳۱ آگوست - شروع فروش از ۱ می', 'حق انصراف ۱۴ روزه از خرید'] },
        'black-friday': { title: 'تغییر بدنی بلک فرایدی', duration: '۱۲ هفته', price: '۱۹۱۹ کرون', subPrice: '۶۵٪ تخفیف ویژه', badge: 'قیمت بی‌نظیر', features: ['۱۰۰٪ برنامه تمرینی کاملاً اختصاصی', 'برنامه غذایی اختصاصی متناسب با هدف', 'پشتیبانی، چک‌این و کوچینگ مداوم', 'فیلم‌های آموزشی دقیق برای حرکات', 'شروع فروش از ۲۰ نوامبر', 'ظرفیت بسیار محدود پکیج'] },
        christmas: { title: 'آفر ویژه کریسمس', duration: '۱۶ هفته', price: '۱۹۹۹ کرون', subPrice: 'بهترین هدیه برای سلامتی خودتان', badge: 'ویژه کریسمس', features: ['برنامه تمرینی اختصاصی (باشگاه یا خانه)', 'برنامه غذایی منعطف و کارآمد', 'بررسی هفتگی وضعیت توسط مربی', 'ویدیوهای راهنمای اجرای ایمن حرکات', 'شروع فروش از ۱ دسامبر', 'هدیه‌ای ماندگار برای سلامتی طولانی‌مدت'] },
        'pt-online-26': { title: 'پکیج کامل PT آنلاین', duration: '۲۶ هفته', price: '۴۶۹۹ کرون', subPrice: 'دانشجویان/جوانان/بازنشستگان: ۴۲۵۰ کرون', badge: 'بهترین ارزش خرید', features: ['تمرین و تغذیه اختصاصی بر اساس هدف شما', 'تنظیم مداوم سنگینی وزنه‌ها به صورت ماهیانه', 'توضیحات دقیق حرکات به همراه ویدیوها', 'چک‌این منظم وضعیت (هفتگی یا ماهانه)', 'دیدگاه همه‌جانبه (خواب، ریکاوری، وضعیت هوازی)', 'پشتیبانی مستقیم در واتس‌اپ و ایمیل'] },
        'next-level-26': { title: 'پکیج Next Level 26', duration: '۲۶ هفته', price: '۴۱۰۵ کرون', subPrice: 'دانشجویان/جوانان/بازنشستگان: ۳۸۲۸ کرون', badge: 'پشتیبانی چندزبانه', features: ['برنامه تمرینی و تغذیه اختصاصی', 'پشتیبانی چندزبانه (کوچینگ به زبان مادری شما)', 'پشتیبانی به زبان‌های عربی، ترکی، فارسی، آلمانی و...', 'ارتباط نامحدود با مربی در واتس‌اپ/ایمیل', 'بروزرسانی منظم برنامه‌ها بر اساس پیشرفت', '۱۰۰٪ امنیت و ارتباط بسیار واضح‌تر با مربی'] },
        'body-reboot-26': { title: 'بازسازی بدنی ۲۶ هفته‌ای', duration: '۲۶ هفته', price: '۳۸۵۰ کرون', subPrice: 'دانشجویان/جوانان/بازنشستگان: ۳۲۵۰ کرون', badge: 'مخصوص افراد باسابقه', features: ['برای ورزشکاران در سطح متوسط یا پیشرفته', 'نیاز به آشنایی اولیه و خوب با تکنیک حرکات', 'برنامه زمان‌بندی حرفه‌ای برای پیشرفت مداوم', 'پشتیبانی مستمر تغذیه و تمرین تخصصی', 'ایجاد عادت‌های پایدار بدون رژیم‌های سخت و ممنوعیت', 'چک‌این‌های منظم برای دستیابی به نتایج ایده‌آل'] },
        'lifestyle-16': { title: 'شروع سبک زندگی سالم', duration: '۱۶ هفته', price: '۳۱۰۵ کرون', subPrice: 'دانشجویان/جوانان/بازنشستگان: ۲۸۴۰ کرون', badge: 'پرفروش‌ترین', features: ['برنامه تمرینی و تغذیه کاملا اختصاصی', 'تعادل مواد مغذی بهینه (پروتئین، فیبر, ویتامین‌ها)', 'دستورهای غذایی ساده و متنوع (سازگار با گیاه‌خواری/حساسیت)', 'ویدیوهای آموزشی برای تمام تمرینات قدرتی', 'ارزیابی مداوم پیشرفت و اصلاح برنامه', 'مشاوره اختصاصی برای بهبود خواب و ریکاوری'] },
        'glute-leg-16': { title: 'پکیج تخصصی پا و باسن', duration: '۱۶ هفته', price: '۳۰۰۰ کرون', subPrice: 'دانشجویان/جوانان/بازنشستگان: ۲۸۱۰ کرون', badge: 'مخصوص بانوان', features: ['فقط مخصوص بانوان (تمامی سطوح از مبتدی تا پیشرفته)', 'تمرکز ویژه روی عضلات پا و باسن', 'شامل تمرینات تکمیلی برای بقیه عضلات بدن', 'برنامه غذایی کامل با تعادل مغذی بهینه', 'پشتیبانی نامحدود و مستقیم از طریق چت', 'بروزرسانی منظم برنامه بر اساس پیشرفت شما'] },
        'fokus-12': { title: 'تمرکز ۱۲ هفته‌ای', duration: '۱۲ هفته', price: '۲۴۶۹ کرون', subPrice: 'دانشجویان/جوانان/بازنشستگان: ۲۲۱۵ کرون', badge: 'استاندارد', features: ['برنامه تمرینی شخصی‌سازی شده اختصاصی', 'برنامه غذایی پایدار (بدون رژیم‌های سخت و عجیب)', 'پیگیری مستمر وضعیت و کوچینگ مربی', 'ویدیوهای راهنما برای تمامی حرکات بدنسازی', 'توصیه‌های تخصصی برای ویتامین‌ها و مکمل‌ها', 'بروزرسانی och اصلاح مداوم برنامه تمرینی شما'] },
        'health-8': { title: 'قدرت و سلامتی', duration: '۸ هفته', price: '۱۸۲۹ کرون', subPrice: 'دانشجویان/جوانان/بازنشستگان: ۱۴۹۹ کرون', badge: 'فشرده och پرقدرت', features: ['تغییر بدنی سریع ۸ هفته‌ای', 'برنامه تمرینی کاملا سفارشی (خانه یا باشگاه)', 'برنامه غذایی اختصاصی بر اساس غذاهای مورد علاقه شما', 'چک‌این‌های هفتگی برای حفظ انگیزه och تعهد', 'ویدیوهای دقیق آموزشی برای اجرای ایمن حرکات', 'راهنمای کامل برای رسیدن به نتایج دلخواه شما'] },
        'kickstart-4': { title: 'پروژه ۴ هفته‌ای', duration: '۴ هفته', price: '۱۱۲۹ کرون', subPrice: 'دانشجویان/جوانان/بازنشستگان: ۸۵6 کرون', badge: 'کیک‌استارت', features: ['شروعی پرقدرت یا برای شکستن استپ وزنی och بدنی', 'برنامه تمرینی فشرده och متناسب با تمامی سطوح', 'برنامه غذایی بسیار ساده، کاربردی och پایدار', 'ارتباط نزدیک och مستمر با مربی خودتان', 'ویدیوهای آموزشی برای تمام حرکات ورزشی', 'بازخورد بسیار سریع مربی نسبت به پیشرفت شما'] },
        nutrition: { title: 'برنامه غذایی پیشرفته', duration: 'خرید یک‌باره', price: '۲۴۵۸ کرون', subPrice: 'برنامه کامل غذایی', badge: 'فقط تغذیه', features: ['۲۰ دستور غذایی منحصر به فرد och کاربردی', 'تقسیم شده به ۵ وعده غذایی مغذی در روز', 'متناسب با سبک زندگی och علایق غذایی شما', 'تعادل مغذی بهینه (پروتئین، فیبر och ویتامین‌ها)', 'غذاهای ساده och خوشمزه جهت ثبات قند خون och انرژی', 'راهنمای خوردن هوشمندانه‌تر och احساس سلامتی بیشتر'] },
        'tech-60': { title: 'جلسه آموزش teknik حرکات', duration: '۶۰ دقیقه', price: '۴۹۹ کرون', subPrice: 'دانشجویان/جوانان/بازنشستگان: 340 کرون', badge: 'جلسه حضوری', features: ['جلسه حضوری för korrekt teknik i övningar', 'Fokus på marklyft, knäböj och bänkpress', 'Möjlighet att välja specifika övningar själv', 'Session uppdelad i uppvärmning & teknikfokus', 'Tydliga instruktioner för att undvika skador', 'Nedvarvning och feedback ingår'] },
        'individual-pt': { title: 'مربیگری شخصی حضوری', duration: '۶۰ دقیقه هر جلسه', price: '۴۹۹ کرون', subPrice: 'رزرو ۲۰ جلسه به مبلغ ۷۸۵۰ کرون (۳۹۲ کرون/جلسه)', badge: 'مربی حضوری', features: ['جلسات تمرینی حضوری متناسب با اهداف شما', 'شامل برنامه تمرینی کاملاً اختصاصی', 'برنامه غذایی متصل och هماهنگ با زندگی روزمره شما', 'شامل پشتیبانی، ارزیابی och کوچینگ مستمر مربی', 'آموزش تخصصی تکنیک‌ها در داخل باشگاه', 'ساعات تمرینی کاملاً انعطاف‌پذیر och توافقی'] }
      },

      // Apply Page
      applySubtitle: 'اولین قدم را بردارید',
      applyTitle: 'ارسال فرم ثبت نام و علاقه',
      applyIntro: 'فرم زیر را با دقت پر کنید. این اطلاعات به ما کمک می‌کند تا برنامه‌ای کاملاً منطبق با شرایط شما آماده کنیم. ارسال این فرم کاملاً رایگان بوده و هیچ تعهدی برای شما ایجاد نمی‌کند.',
      applyContactEmailTitle: 'ایمیل جهت سوالات',
      applyContactPhoneTitle: 'تلفن / واتس‌اپ',
      applyContactLocationTitle: 'محل تمرین',
      applyContactLocationText: 'تمرین به صورت آنلاین یا حضوری در محیط باشگاه',
      applyDisclaimer: 'طبق قانون، حق انصراف ۱۴ روزه för alla distansköp.',
      applyLabelFullName: 'نام و نام خانوادگی *',
      applyPlaceholderFullName: 'نام و نام خانوادگی خود را وارد کنید',
      applyLabelGender: 'جنسیت *',
      applyOptionFemale: 'زن',
      applyOptionMale: 'مرد',
      applyOptionOther: 'دیگر / ترجیح می‌دهم اعلام نکنم',
      applyLabelAge: 'سن *',
      applyPlaceholderAge: 'سال',
      applyLabelCity: 'شهر *',
      applyPlaceholderCity: 'مانند استکهلم',
      applyLabelEmail: 'آدرس ایمیل *',
      applyPlaceholderEmail: 'name@email.com',
      applyLabelPhone: 'شماره تلفن *',
      applyPlaceholderPhone: 'مانند +46 70-000 00 00',
      applyLabelWish: 'پکیج مورد نظر جهت تمرین *',
      applyPlaceholderWish: '-- یک پکیج تمرینی انتخاب کنید --',
      applyLabelMessage: 'پیام شما / سابقه ورزشی قبلی (اختیاری)',
      applyPlaceholderMessage: 'شرایط بدنی فعلی، اهداف یا مصدومیت‌های قبلی خود را به طور خلاصه بنویسید...',
      applyBtnSubmit: 'ارسال فرم ثبت نام',
      applyBtnSending: 'در حال ارسال...',
      applyErrorFields: 'لطفاً تمامی فیلدهای الزامی را پر کنید.',
      applySuccessTitle: 'با تشکر از درخواست شما!',
      applySuccessText: 'سلام {name}. درخواست شما برای پکیج {wish} با موفقیت دریافت شد.',
      applySuccessSubtext: 'مربی رسمی علی وفا تا ۲۴ ساعت آینده از طریق ایمیل ({email}) یا تلفن ({phone}) با شما تماس خواهد گرفت تا برنامه شما را بررسی کند.',
      applySuccessBack: 'بازگشت به صفحه اصلی',
      
      // Footer & Partners Extra Links
      idealLink: 'مشتری ایده‌آل',
      termsLink: 'شرایط و اطلاعات',
      whyStrengthLink: 'چرا بدنسازی؟',
      visitPartner: 'بازدید از وب‌سایت',
      partnerWeightworldDesc: 'مکمل‌های غذایی و محصولات بهداشتی باکیفیت برای کاهش وزن و انرژی.',
      partnerStaybeautifulDesc: 'محصولات زیبایی و مراقبت از پوست برای یک زندگی سالم‌تر و شاداب‌تر.',
      partnerApulsDesc: 'تجهیزات ورزشی و دستگاه‌های حرفه‌ای بدنسازی برای تمرین در خانه.',
      partnerMindlyDesc: 'ابزارهای تمرین ذهنی، خودیاری و توسعه فردی.',
      partnerMusclepainDesc: 'تفنگ‌های ماساژور و محصولات ریکاوری برای عضلات خسته.',
      partnerSskbutikenDesc: 'محصولات سلامتی، کفش‌های راحت و تجهیزات حمایتی برای ورزشکاران.',
      
      // Footer specific translations
      footerTagline: 'ما نه تنها یک ظاهر قوی‌تر می‌سازیم، بلکه قدرت و تمرکز درونی شما را نیز توسعه می‌دهیم.',
      footerNavTitle: 'ناوبری',
      footerInfoTitle: 'اطلاعات بیشتر',
      footerContactTitle: 'تماس و پشتیبانی',
      footerSupportHours: 'زمان پاسخگویی: ۲۴ تا ۴۸ ساعت در روزهای کاری. روزهای تعطیل تا ۷۲ ساعت.'
    }
  }
